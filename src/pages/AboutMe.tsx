    ...
    <div className="min-h-screen bg-white font-montserrat">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="fade-in">
          <h1 className="text-5xl font-playfair font-bold mb-8 text-center">About Me</h1>
          ...
          <div className="mb-12 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2 scale-in" style={{ animationDelay: "0.2s" }}>
              <h2 className="text-3xl font-playfair font-bold mb-4">The Passion Behind the Lens</h2>
          ...
          <div className="fade-in" style={{ animationDelay: "0.4s" }}>
            <h2 className="text-3xl font-playfair font-bold mb-6">My Journey</h2>
          ...
          <div className="scale-in" style={{ animationDelay: "0.6s" }}>
            <h2 className="text-3xl font-playfair font-bold mb-6">My Approach</h2>
            <p className="text-gray-700 mb-6 leading-relaxed">
